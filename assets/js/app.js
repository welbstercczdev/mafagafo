// assets/js/app.js (ARQUITETURA FINAL - CÓDIGO COMPLETO)
const app = {
    ...
    async handleLogin(e) {
        ...
        if (result.success) {
            ...
            await this.checkAuthStatus(); // Apenas atualiza o estado
            router.resolve(router.repoName + '/dashboard'); // Manda o roteador redesenhar
        } else {
